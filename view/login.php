...
<div class="container py-5">
    <div class="row py-5">
        <form class="col-md-9 m-auto border p-3 shadow" style="border-radius: 0px 70px;" action="<?= url("Do-Login"); ?>" method="POST" role="form">
            <div class="row p-3">
                ...
                <div class="mb-3">
                    ...
                    <a class="navbar-sm-brand text-grey text-decoration-none" href="<?= url("register"); ?>">Register</a>
                </div>
            </div>
            <div class="row">
